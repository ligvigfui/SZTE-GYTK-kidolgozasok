...
<table>
    ...
    <tbody>
        <tr>
            <td>Dopamin</td>
            <td rowspan=2>β<sub>1</sub> receptorok aktiválása ⇒ +inotrop hatás<br>hátrány: +kronotrop hatás, β<sub>1</sub> downreguláció</td>
            <td rowspan=2>kardiogén sokk, terápiarezisztens szívelégtelenség</td>
        </tr>
        <tr>
            <td>Dobutamin</td>
        </tr>
...
<table>
    <thead>
        <tr>
            <th>Hatóanyag</th>
            <th>Feltételezett hatásmechanizmus</th>
            <th>Indikáció</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td>Dapagliflozin</td>
            <td rowspan=2>Kardiovaszkuláris mortalitást csökkent<br>Feltételezik, hogy a glükóz reabszorbció gátlásával ⇒ csökkent előterhelés, csökkent artériás merevség</td>
            <td rowspan=2>Krónikus szívelégtelenség</td>
        </tr>
        <tr>
            <td>Empagliflozin</td>
        </tr>
